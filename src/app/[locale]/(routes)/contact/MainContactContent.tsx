...
const MainContactContent = ({ contactInfo }: MainContactContentProps) => {
  return (
    <div className="flex items-center justify-center max-w-[1400px] w-full mx-auto gap-16 max-md:gap-4 shadow-lg max-md:flex-col h-max max-md:p-[30px] my-8 max-md:mt-2 flex-1">
