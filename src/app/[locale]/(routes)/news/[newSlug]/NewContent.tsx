  ...
  return (
    ...
    >
      ...
      <p className="text-primary text-[13px] mb-[32px] max-md:text-sm">
        Our dedicated team at DMA had the privilege of attending the highly
        anticipated launch of Mountain View’s latest project, “Mountain View I,”
        at Cityscape Global 2024. This monumental 55-acre development, situated
        in the vibrant North Riyadh City, is poised to redefine the city’s
        skyline and elevate its urban landscape. As a key partner in this
        ambitious endeavor, DMA played a pivotal role in the design and master
        planning of Mountain View I. Our team of expert architects, urban
        planners, and landscape designers worked tirelessly to create a
        visionary development that seamlessly blends modern aesthetics with
        traditional Saudi Arabian culture.
      </p>
      <div className="flex gap-3 flex-wrap flex-col">
        ...
        <div id="share" className="flex items-center gap-4">
          <Link
            ...
            aria-label="Facebook"
            href="https://www.facebook.com/share_channel/?type=reshare&link=https://dma-mea.com/news/7&source_surface=external_reshare&display&quote=DMA Contributes to Riyadh's Skyline with Mountain View I&hashtag=DMA Contributes to Riyadh's Skyline with Mountain View I"
          >
            <svg
          ...
          <Link
            ...
            className="bg-primary p-1.5 rounded-full flex items-center justify-center"
            aria-label="LinkedIn"
            href="https://www.linkedin.com/feed/?shareActive=true&shareUrl=https://dma-mea.com/news/7"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="14"
