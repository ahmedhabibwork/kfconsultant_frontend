                    ...
                    >
                        <div className="sm:h-screen max-sm:px-[30px] px-[60px] md:px-[120px] pt-[113px] max-sm:py-[60px] pb-[30px] md:pb-[80px] flex flex-col md:flex-row md:justify-between gap-8 lg:items-center relative">
                            <button
                                ...
                                className="absolute top-[48px] ltr:right-4 rtl:left-4 md:ltr:right-[120px] md:rtl:left-[120px]"
                            ...
                            <div className="absolute inset-0 -z-10">
                                <Image
                                    ...
                                    priority
                                />
                                <div className="bg-overlay bg-primary/95"></div>
                            </div>
                            ...
                            <div className="flex flex-col gap-[16px] md:gap-[24px] relative z-10">
                                {[
                                    ...
                                    <div key={link.href} className="group/parent relative flex items-center">
                                        <Link
                                            className="flex gap-4 items-center text-[24px] md:text-[34px] transition-transform duration-300 group-hover/parent:text-secondry text-white"
                                            href={link.href}
                                            onClick={() => setIsOpen(false)}
                                        >
                                            <div className="relative inline-block">
                                                <div className="absolute top-1/2 transform -translate-y-1/2 transition-transform duration-300 opacity-0 lg:group-hover/parent:opacity-100 left-0">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="41" height="25" viewBox="0 0 71 25" fill="none">
                                                        <path d="M60.9873 6.34631L67.0573 12.4163L60.9873 18.4863" className="stroke-white group-hover/parent:stroke-secondry" strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"></path>
                                                        <path d="M3.97266 12.4163L66.8871 12.4163" className="stroke-white group-hover/parent:stroke-secondry" strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"></path>
                                                    </svg>
                                                </div>
                                                <span className="inline-block transition-transform duration-300 lg:group-hover/parent:translate-x-20">
                                                    {link.label}
                                                </span>
                                            </div>
                                        </Link>
                                    ...
                                    <div className="flex flex-col gap-[10px]">
                                        <a className="flex items-center gap-2" href="https://www.google.com/maps/place/%D8%AF%D9%89+%D8%A7%D9%85+%D8%A7%D9%8A%D9%87+-+%D8%AF%D8%A7%D8%B1+%D8%A7%D9%84%D9%85%D8%B9%D9%85%D8%A7%D8%B1+%D9%84%D9%84%D8%A7%D8%B3%D8%AA%D8%B4%D8%A7%D8%B1%D8%A7%D8%AA+%D8%A7%D9%84%D9%87%D9%86%D8%AF%D8%B3%D9%8A%D8%A9%E2%80%AD/@30.0923338,31.3731537,19.43z/data=!4m6!3m5!1s0x1458158dbf37b047:0xee228a3e21f0fe5!8m2!3d30.0921302!4d31.3725772!16s%2Fg%2F11cn6f7wp3?entry=ttu&amp;g_ep=EgoyMDI0MTAyMy4wIKXMDSoASAFQAw%3D%3D">
                                            ...
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 33 33" fill="none">
                                                <path d="M25.1597 6.625H18.2828C17.603 6.625 17.0501 7.17804 17.0501 7.85773C17.0501 8.53743 17.603 9.09047 18.2828 9.09047H22.1837L15.6766 15.5975C15.4436 15.8303 15.3154 16.1398 15.3154 16.4692C15.3154 16.7986 15.4436 17.108 15.6764 17.3406C15.9093 17.5737 16.2188 17.702 16.5482 17.702C16.8774 17.702 17.187 17.5738 17.42 17.3408L23.9269 10.8338V14.7346C23.9269 15.4143 24.48 15.9674 25.1597 15.9674C25.8394 15.9674 26.3924 15.4143 26.3924 14.7346V7.85773C26.3924 7.17804 25.8394 6.625 25.1597 6.625Z" fill="#fff"></path>
                                                <path d="M20.561 24.5117H8.50583V12.4565H17.5725L19.6857 10.3433H7.44921C6.86567 10.3433 6.39258 10.8163 6.39258 11.3999V25.5684C6.39258 26.1519 6.86567 26.625 7.44921 26.625H21.6177C22.2012 26.625 22.6743 26.1519 22.6743 25.5684V13.3318L20.561 15.4451V24.5117Z" fill="#fff"></path>
                                            </svg>
                                        </a>
                                        <p className="text-[12px]">87, El-Mosheer Ahmed Ismail st.,<br /> Sheraton, Heliopolis, Cairo, Egypt.</p>
                                    </div>
                                </div>
                                <div className="mb-[20px] md:mb-[40px] flex">
                                    <Link href="/contact">
                                        <button className="group/parent text-white hover:text-secondry w-[130px] min-h-[60px] h-[60px] relative flex items-center justify-center rtl:rotate-180 undefined" onClick={() => setIsOpen(false)}>
                                            <p className="rtl:rotate-180 text-[13px]">Contact Us</p>
                                            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="130" height="61" viewBox="0 0 201 61" fill="none">
                                                    <path id="Subtract" fillRule="evenodd" clipRule="evenodd" d="M1.45605 1.41626H199.456V14.0148H200.456V1.41626V0.41626H199.456H1.45605H0.456055V1.41626V59.4163V60.4163H1.45605H199.456H200.456V59.4163V46.8176H199.456V59.4163H1.45605V1.41626Z" className="fill-white group-hover/parent:fill-secondry"></path>
                                                </svg>
                                            </div>
